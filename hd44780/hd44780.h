...
//-------------------------------
#define LCD_WIRE          		      GPIOC->ODR // select your microcontroller gpio port
#define SET_R						  ODR //
#define E  		 	   	  		      0 // pin number in selected port
#define RS 		  	   	  		      1 // pin number in selected port
#define D7 		 	   	  		      2 // pin number in selected port
#define D6 		 	   	  		      3 // pin number in selected port
#define D5 		 	   	  		      4 // pin number in selected port
#define D4 		  	   	  		      5 // pin number in selected port
//-------------------------------
// SELECT MCU FREQUENCE
//-------------------------------
#define MCU_CLK_VALUE				  F_CPU/4 /* in MHz. Minimal value - 1 MHz */
